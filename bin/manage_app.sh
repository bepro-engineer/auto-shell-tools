...
Example:
  sh manage_app.sh -b http://localhost:8080 -u admin -p admin123 -c list
  sh manage_app.sh -b http://localhost:8080 -u admin -p admin123 -a /docs -c stop
  sh manage_app.sh -b http://localhost:8080 -u admin -p admin123 -f /opt/tomcat9/conf/apps_online.lst -c start
--------------------------------------
EOF
}
